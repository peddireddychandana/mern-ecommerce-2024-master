    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        ...
        <div style="padding:20px;background:#f9f9f9;">
          ...
          <a href="http://localhost:5173/admin/orders" style="display:block;margin-top:20px;padding:12px;background:#6B1E2E;color:#fff;text-align:center;text-decoration:none;border-radius:5px;font-size:16px;">View in Admin Panel</a>
        </div>
      </div>`;
...
async function notifyPaymentVerification(order) {
  try {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        ...
        <div style="padding:20px;background:#f9f9f9;">
          ...
          <a href="http://localhost:5173/admin/orders" style="display:block;margin-top:10px;padding:12px;background:#e67e22;color:#fff;text-align:center;text-decoration:none;border-radius:5px;font-size:16px;">Go to Admin Panel</a>
        </div>
      </div>`;
    ...
    console.log("Verification email sent for order", order._id);
  } catch (err) {
    console.error("Email error:", err.message);
  }
}
